...
const ActionButton = ({
  ...
  <motion.button
    ...
    onClick={onClick}
    disabled={disabled}
    className="mt-8 px-8 py-3 rounded-full bg-red-500 text-white font-semibold shadow-lg transition-colors hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-opacity-75 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
  >
    {children}
  </motion.button>
);
  ...
  return (
    ...
    >
      <div className="z-10 flex flex-col items-center">
        ...
        >
          <ActionButton onClick={onCtaClick} disabled={ctaDisabled}>
            {ctaText}
          </ActionButton>
        </motion.div>
      </div>
